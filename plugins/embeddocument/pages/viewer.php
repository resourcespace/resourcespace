        ...
        <div class="embeddocument_player">
            ...
            <script type="text/javascript">
                ...
                while (true) {
                    ...
                    ?>
                    embeddocument_pages[<?php echo $page ?>]='<a href="#" onClick="embeddocument_ShowPage(<?php echo $page + 1 ?>,false,false);"><img border="0" width="100%" src="<?php echo $preview_path ?>"></a>';
                    <?php
