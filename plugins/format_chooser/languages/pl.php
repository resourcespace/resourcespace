...
$lang["format_chooser_blocked_inputs"] = '<p>Poniższych formatów nie obsługuje się do wprowadzania: %s</p>';
$lang["format_chooser_blocked_outputs"] = '<p>Poniższych formatów nie obsługuje się do wyjścia: %s</p>';