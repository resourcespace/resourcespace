...
$lang["format_chooser_blocked_inputs"] = '<p>Следующие форматы не поддерживаются для ввода: %s</p>';
$lang["format_chooser_blocked_outputs"] = '<p>Следующие форматы не поддерживаются для вывода: %s</p>';